package com.cys.mvvm.model

import android.content.Context

//데이터를 제어하는 기능 2개를 가진 클래스
class ItemModel constructor(val context: Context) { //데이터를 제어하기 위해서 Context능력이 필요한 경우가 있다면 주 생성자로 전달 받기

    //1] 데이터를 전달받아 SharedPreferences 에 데이터를 저장하는기술 기능
